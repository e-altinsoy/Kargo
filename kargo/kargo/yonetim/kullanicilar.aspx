...
<div>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Kargo_OtomasyonuConnectionString2 %>" DeleteCommand="DELETE FROM [tbl_kullanicilar] WHERE [kullanici_no] = @kullanici_no" InsertCommand="INSERT INTO [tbl_kullanicilar] ([kullanici_adi], [parola], [adsoyad], [eposta], [adres], [yetki], [uyelik_tarihi]) VALUES (@kullanici_adi, @parola, @adsoyad, @eposta, @adres, @yetki, @uyelik_tarihi)" SelectCommand="SELECT * FROM [tbl_kullanicilar]" UpdateCommand="UPDATE [tbl_kullanicilar] SET [kullanici_adi] = @kullanici_adi, [parola] = @parola, [adsoyad] = @adsoyad, [eposta] = @eposta, [adres] = @adres, [yetki] = @yetki, [uyelik_tarihi] = @uyelik_tarihi WHERE [kullanici_no] = @kullanici_no">
        <DeleteParameters>
