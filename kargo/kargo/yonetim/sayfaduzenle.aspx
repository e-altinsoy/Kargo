<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sayfaduzenle.aspx.cs" Inherits="kargo.yonetim.sayfaduzenle" ValidateRequest="false" %>
...
<div class="govde">
<div class="baslik">Sayfa Düzenle</div>
<div class="bosluk">
<asp:Label ID="Label1" runat="server"></asp:Label>
        <table class="auto-style1">
        <tr>
            <td class="font">Sayfa Başlık</td>
            <td class="font">:</td>
            <td>
        ...
        <tr>
            <td class="font" style="vertical-align: top">Sayfa İçerik</td>
        ...
        <tr>
            ...
            <td>&nbsp;</td>
            <td>
                <asp:Button ID="Button1" runat="server" Text="Sayfa Düzenle" CssClass="button" OnClick="Button1_Click" />
            </td>
        </tr>
        </table>
    </div>
