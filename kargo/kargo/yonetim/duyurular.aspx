...
<div>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Kargo_OtomasyonuConnectionString2 %>" SelectCommand="SELECT [baslik], [duyuruid] FROM [tbl_duyurular]"></asp:SqlDataSource>
    </div>
</div>
