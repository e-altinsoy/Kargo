...
<div class="bosluk">
    ...
    <asp:FormView ID="FormView1" runat="server" CssClass="font" AllowPaging="True" BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px" CellPadding="2" DataKeyNames="sube_no" DataSourceID="SqlDataSource1" ForeColor="Black" Width="876px">
        ...
        <PagerStyle BackColor="PaleGoldenrod" ForeColor="PaleGoldenrod" HorizontalAlign="Center" />
    </asp:FormView>
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Kargo_OtomasyonuConnectionString2 %>" DeleteCommand="DELETE FROM [tbl_subeler] WHERE [sube_no] = @sube_no" InsertCommand="INSERT INTO [tbl_subeler] ([sube_adi], [sube_adres]) VALUES (@sube_adi, @sube_adres)" SelectCommand="SELECT * FROM [tbl_subeler]" UpdateCommand="UPDATE [tbl_subeler] SET [sube_adi] = @sube_adi, [sube_adres] = @sube_adres WHERE [sube_no] = @sube_no">
        <DeleteParameters>
