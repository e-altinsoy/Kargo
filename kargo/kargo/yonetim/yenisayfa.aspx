<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="yenisayfa.aspx.cs" Inherits="kargo.yonetim.yenisayfa" ValidateRequest="false" %>
...
<div class="govde">
<div class="baslik">Sayfa Ekle</div>
<div class="bosluk">
<asp:Label ID="Label1" runat="server"></asp:Label>
        ...
        <tr>
            ...
            <td>&nbsp;</td>
            <td>
                <asp:Button ID="Button1" runat="server" Text="Sayfa Ekle" CssClass="button" OnClick="Button1_Click" />
            </td>
        </tr>
        </table>
    </div>
