<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="yenikargo.aspx.cs" Inherits="kargo.yonetim.WebForm1" %>
...
<meta content="YBS, YBS kargosu" name="keywords" />
<meta content="YBS Kargo" name="description" />
<title>YBS Kargo</title>
...
<div class="govde">
<div class="baslik">Kargo Ekle</div>
<div class="bosluk">
<asp:Label ID="Label1" runat="server"></asp:Label>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:Kargo_OtomasyonuConnectionString2 %>" SelectCommand="SELECT * FROM [tbl_kargo_turleri]"></asp:SqlDataSource>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Kargo_OtomasyonuConnectionString2 %>" SelectCommand="SELECT [sube_no], [sube_adi] FROM [tbl_subeler]"></asp:SqlDataSource>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>&nbsp;</td>
            <td>
                <asp:Button ID="Button1" runat="server" Text="Kargo Ekle" CssClass="button" OnClick="Button1_Click" />
            </td>
        </tr>
        </table>
    </div>
