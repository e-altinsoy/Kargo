...
<div class="bosluk">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Kargo_OtomasyonuConnectionString2 %>" SelectCommand="SELECT * FROM [tbl_kargo]"></asp:SqlDataSource>
    </div>
    <div>
