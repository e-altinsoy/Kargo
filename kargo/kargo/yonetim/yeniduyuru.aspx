<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="yeniduyuru.aspx.cs" Inherits="kargo.yonetim.yeniduyuru" ValidateRequest="false" %>
...
<asp:Label ID="Label1" runat="server"></asp:Label>
        ...
        <tr>
            ...
            <td>&nbsp;</td>
            <td>
                <asp:Button ID="Button1" runat="server" Text="Duyuru Ekle" CssClass="button" OnClick="Button1_Click" />
            </td>
        </tr>
        </table>
    </div>
